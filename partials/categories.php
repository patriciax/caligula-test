...
<h4 class="wordCarousel" >
    <div>
        <ul class="flip4">
            <li>Choose wisely.</li>
            <li>Do you like animations?</li>
            <li>We like them a lot!</li>
            <li>Bring any story to life</li>
        </ul>
    </div>
</h4>
<!----
            ...
            <div class="main-card">
              ...
              <h2>
                ...
                <!---  <span class="c-lerp-block_title" data-scroll>
                    ...
                    <span data-scroll data-scroll-delay="0.1" data-scroll-speed="6">t</span>
                    <span data-scroll data-scroll-delay="0.09" data-scroll-speed="6">h</span>
                ...
                <div class="c-lerp-block titlte-categories">
                 ...
                 <!--- <br>
                  <span class="c-lerp-block_title" data-scroll>
                    ...
                    <span data-scroll data-scroll-delay="0.11" data-scroll-speed="6">g</span>
                    <span data-scroll data-scroll-delay="0.1" data-scroll-speed="6">a</span>
                    <span data-scroll data-scroll-delay="0.09" data-scroll-speed="6">n</span>
                    <span data-scroll data-scroll-delay="0.08" data-scroll-speed="6"></span>
                    <span data-scroll data-scroll-delay="0.07" data-scroll-speed="6">AF</span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6"></span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6">&</span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6"></span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6">A</span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6">l</span>
                    <span data-scroll data-scroll-delay="0.06" data-scroll-speed="6">c</span>
